Feature: Buscar Profissional Pos Cadastro
    ...
    Scenario: [CT-018] Verificar campo de busca
    ...
    Scenario Outline: [CT-019] Validar lista de profissionais cadastrados no sistema 
    ...
    | 011 | O paciente selecionar a Lupa   | não inserir nenhuma informação   |  Existir elementos na base de dados      | Deve ser redirecionado para uma página de listagem com todos os profissionais cadastrados no sistema|