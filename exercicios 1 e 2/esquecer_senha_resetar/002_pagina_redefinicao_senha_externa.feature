Feature: Redefinição de senha após receber o e-mail de recuperação
    ...
    Scenario: [CT-043] Redirecionamento após clicar no botão "Redefinir senha" no e-mail
    ...
    Scenario Outline: [CT-044] Validar requisitos mínimos da nova senha
    ...
    Scenario: [CT-045] Verificar se as senhas "Nova senha" e "Confirme nova senha" são iguais
        Given que o usuário esteja na página de confirmação de Redefinição de Senha
    ...
    Scenario: [CT-046] Exibir lista de requisitos mínimos com "x" em vermelho para senha incorreta
        Given que o usuário esteja na página de confirmação de Redefinição de Senha
    ...
    Scenario: [CT-047] Exibir lista de requisitos mínimos com "v" em verde para senha válida
        Given que o usuário esteja na página de confirmação de Redefinição de Senha
    ...
    Scenario: [CT-048] Inserir a mesma senha atual como "Nova senha"
        Given que o usuário esteja na página de confirmação de Redefinição de Senha
